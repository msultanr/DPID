...
<link rel="stylesheet" href="Archive.css" media="screen">
  ...
  <a class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-custom-color-2 u-text-grey-90 u-text-hover-grey-90" href="Archive.php" style="padding: 8px;">Archive</a>
  <!-- <div class="u-nav-popup">
    <ul class="u-custom-font u-font-georgia u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link u-white">DPID</a>
        ...
        <form action="Transaction/upload.php" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;" name="form" method="post" enctype="multipart/form-data">
            ...
            <select class="form-control" name="Recipient" id="recipient">
              ...
              <?php
                ...
                $select->execute();
                $res1 = $select->get_result();
                while ($row = $res1->fetch_assoc()) {
                    echo "<option value='" . $row['VENDOR_NAME'] . "'>" . $row['EMAIL'] . "</option>";
                }
              ?>
            </select>
              <!-- <div class="u-form-group u-form-name u-label-top">
              <label for="name-6797" class="u-label u-label-1">Select Recipient</label>
              <input type="text" placeholder="Email Recipient" id="recipient" name="Recipient" class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-radius u-input-1" required="">
            </div> -->
                <?php
              }
            ?>
              <div class="u-form-group u-form-name u-label-top">
              <label for="name-6797" class="u-label u-label-1">Subject</label>
              <input type="text" placeholder="Subject" id="subject" name="Subject" class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-radius u-input-1" required="">
            </div>
            <div class="u-form-group u-form-message u-label-top">
              <label for="Description-6797" class="u-label u-label-2">Description</label>
              <textarea placeholder="Description" id="description" name="Description" class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-radius u-input-2" required="required" rows="5"></textarea>
            </div>
            <div class="u-form-group u-form-time u-label-top">
              <label for="message-6797" class="u-label u-label-3">Attachment</label>
              <input placeholder="Attachment" rows="4" cols="50" id="attachment" name="Attachment[]" class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-radius u-input-3" required="required" type="file" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint, text/plain, application/pdf" multiple>
            </div>
